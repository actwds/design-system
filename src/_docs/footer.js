					...
					<div className="act-flex__row">
						...
						<div className="act-col__cw-3">
							<div className="act-box">
								<div className="act-footer-nav">
									<h4>
										<LinkTo kind="governance-overview--page">
											Governance
										</LinkTo>
									</h4>
									<ul>
										<li>
											<LinkTo kind="governance-contribute-a-component--page">
												Contribute a component
											</LinkTo>
										</li>
										<li>
											<LinkTo kind="governance-suggest-changes--page">
												Suggest changes
											</LinkTo>
										</li>
									</ul>
						...
						<div className="act-col__cw-3">
							<div className="act-box">
								<div className="act-footer-nav">
									...
									<ul>
										<li>
											<LinkTo kind="governance-supporting-guidelines-accessibility--page">
												Accessibility
											</LinkTo>
										</li>
										<li>
											<LinkTo kind="governance-supporting-guidelines-branding--page">
												Branding
											</LinkTo>
										</li>
										<li>
											<LinkTo kind="governance-supporting-guidelines-content--page">
												Content
											</LinkTo>
										</li>
										<li>
											<LinkTo kind="governance-supporting-guidelines-glossary--page">
												Glossary
											</LinkTo>
										</li>
										<li>
											<LinkTo kind="governance-supporting-guidelines-policies--page">
												Policies
											</LinkTo>
										</li>
									</ul>
